...
public class Player
{
  ...
  //to the number of battles in the war, as entered by the player.
  public Player(String playerName, int numberOfBattles)
  {
    ...
    scores = new int[numberOfBattles];
    count = 0;
  }
